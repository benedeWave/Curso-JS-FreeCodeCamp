...
let bot;
bot = "teacherBot"; // en estos pasos estoy repasando como reasignar una variable luego de ser creada.
...
console.log(botIntroduction); // aqui pongo en practica la concatenacion a partir del comando "+"
